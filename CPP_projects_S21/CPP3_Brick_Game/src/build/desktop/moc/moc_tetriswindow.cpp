...
#include <memory>
#include "../../../gui/desktop/tetriswindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TetrisWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TetrisWindow_t qt_meta_stringdata_TetrisWindow = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TetrisWindow[] = {
...
Q_CONSTINIT const QMetaObject TetrisWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_TetrisWindow.offsetsAndSizes,
    qt_meta_data_TetrisWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TetrisWindow_t,
        // Q_OBJECT / Q_GADGET
